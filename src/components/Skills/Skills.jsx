...
const Skills = () => {
    return (
        <section className='px-5 md:px-10 lg:px-20 py-12 bg-gray-500'>
            <h1 className='text-3xl md:text-4xl font-bold text-center mb-5'>My <span className='text-primary'>Skills</span></h1>
